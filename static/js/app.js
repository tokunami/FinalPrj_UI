...
var moverUrl = host + 'data';

$.getJSON(
    moverUrl,
    function(json){
        data = json.top_movers;
        // console.log(data);

        for (i=0; i < 10; i++) {
            var reqUrl = moverUrl +'/'+ data[i];
            var priceUrl = reqUrl;
            ...
            $.getJSON (
                ...
                function (res) {
                    ...
                    var tdHprice = document.createElement("td");
                    var tdLprice = document.createElement("td");
                    var tdBadge = document.createElement("td");

                    var name = document.createTextNode(res[0].stock);
                    var highPrice = document.createTextNode(res[0].price);
                    var lowPrice = document.createTextNode(res[0].price_15min);
                    ...
                    tdHprice.appendChild(highPrice);
                    tdLprice.appendChild(lowPrice);
                    tdBadge.innerHTML = badge;
                    
                    tr.appendChild(document.createElement("td"));
                    tr.appendChild(tdCode);
                    tr.appendChild(tdName);
                    tr.appendChild(tdHprice);
